...
var helpers = {
  ...
  */
  ...
  /**
   if helpers for complex evaluation complex logic expressions.
   Note : #1 if helpers fails gracefully when there is no body block nor else block
  ...
  "if": function( chunk, context, bodies, params ){
      ...
      if(eval(cond)){
       if(body) {
        return chunk.render( bodies.block, context );
         ...
         _console.log( "Missing body block in the if helpers!" );
         return chunk;
       }
      }
      if(skip){
    ...
    // no condition
      ...
      _console.log( "No condition given in the if helpers!" );
    }
    return chunk;
  },
   ...
   * @param method is the math method,  is a valid string supported by math helpers like mod, add, subtract
  ...
  "math": function ( chunk, context, bodies, params ) {
    ...
    if( params && typeof params.key !== "undefined" && params.method ){
      ...
      if (mathOut !== null){
        ...
        if (bodies && bodies.block) {
          // with bodies act like the select helpers with mathOut as the key
          // like the select helpers bodies['else'] is meaningless and is ignored
          return chunk.render(bodies.block, context.push({ isSelect: true, isResolved: false, selectKey: mathOut }));
        } else {
          // self closing math helpers will return the calculated output
    ...
    // no key parameter and no method
      ...
      _console.log( "Key is a required parameter for math helpers along with method/operand!" );
    }
    return chunk;
  },
   /**
   select helpers works with one of the eq/ne/gt/gte/lt/lte/default providing the functionality
  ...
  "select": function(chunk, context, bodies, params) {
    ...
    if( params && typeof params.key !== "undefined"){
      ...
      if( body ) {
       ...
       _console.log( "Missing body block in the select helpers ");
       return chunk;
      }
    }
    // no key
    else {
      _console.log( "No key given in the select helpers!" );
    }
    return chunk;
  },

  /**
   eq helpers compares the given key is same as the expected value
   It can be used standalone or in conjunction with select for multiple branching
   @param key,  The actual key to be compared ( optional when helpers used in conjunction with select)
                either a string literal value or a dust reference
                a string literal value, is enclosed in double quotes, e.g. key="foo"
                a dust reference may or may not be enclosed in double quotes, e.g. key="{val}" and key=val are both valid
   @param value, The expected value to compare to, when helpers is used standalone or in conjunction with select
   @param type (optional), supported types are  number, boolean, string, date, context, defaults to string
  ...
  /**
   ne helpers compares the given key is not the same as the expected value
   It can be used standalone or in conjunction with select for multiple branching
   @param key,  The actual key to be compared ( optional when helpers used in conjunction with select)
                either a string literal value or a dust reference
                a string literal value, is enclosed in double quotes, e.g. key="foo"
  ...
  /**
   lt helpers compares the given key is less than the expected value
   It can be used standalone or in conjunction with select for multiple branching
   @param key,  The actual key to be compared ( optional when helpers used in conjunction with select)
                either a string literal value or a dust reference
                a string literal value, is enclosed in double quotes, e.g. key="foo"
  ...
  /**
   lte helpers compares the given key is less or equal to the expected value
   It can be used standalone or in conjunction with select for multiple branching
   @param key,  The actual key to be compared ( optional when helpers used in conjunction with select)
                either a string literal value or a dust reference
                a string literal value, is enclosed in double quotes, e.g. key="foo"
  ...
  **/
  ...
  /**
   gt helpers compares the given key is greater than the expected value
   It can be used standalone or in conjunction with select for multiple branching
   @param key,  The actual key to be compared ( optional when helpers used in conjunction with select)
                either a string literal value or a dust reference
                a string literal value, is enclosed in double quotes, e.g. key="foo"
 ...
 /**
   gte helpers, compares the given key is greater than or equal to the expected value
   It can be used standalone or in conjunction with select for multiple branching
   @param key,  The actual key to be compared ( optional when helpers used in conjunction with select)
                either a string literal value or a dust reference
                a string literal value, is enclosed in double quotes, e.g. key="foo"
  ...
  **/
  ...
  // to be used in conjunction with the select helpers
  // TODO: fix the helpers to do nothing when used standalone
  ...
  /**
  * size helpers prints the size of the given key
  * Note : size helpers is self closing and does not support bodies
